            ...
            <div className="container d-flex justify-content-between align-items-center">
                ...
                <div className="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                    ...
                    <div className="navbar align-self-center d-flex">
                        ...
                        <Link className="nav-icon position-relative text-decoration-none" to="/sign_up">
                            <i className="fa fa-fw fa-user text-dark mr-3"></i>
                            <span className="top-0 badge rounded-pill text-dark">Войти в IT</span>
                        </Link>

                        <Link className="nav-icon position-relative text-decoration-none" to="/authorization">
